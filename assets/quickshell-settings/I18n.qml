...
QtObject {
    ...
    readonly property var zh: ({
        ...
        "Select an entry, then paste into the focused application.": "选择一条记录，然后粘贴到当前获得焦点的应用。",
        "Loading history…": "正在加载历史记录…",
        "No transcriptions yet.": "暂无转写记录。",
        "Select an entry to preview it.": "选择一条记录以预览全文。",
        "Preview": "预览",
        "Paste": "粘贴",
        "Pasting…": "正在粘贴…",
        "Could not load history.": "无法加载历史记录。",
        "History backend returned invalid data.": "历史记录后端返回了无效数据。",
        "Could not paste transcription.": "无法粘贴转写文本。",
        "Could not start history backend.": "无法启动历史记录后端。",
        "English": "英语",
        ...
        "Primary streaming recognition with an optional native final pass.": "主要使用流式识别，并可选择运行原生最终处理。",
        "Endpoint mode": "端点模式",
        "Regional": "区域路由",
        ...
        "Model preset": "模型预设",
        "GPT OSS 120B (OpenRouter)": "GPT OSS 120B（OpenRouter）",
        "Qwen3.8 27B (Alibaba Beijing)": "Qwen3.8 27B（阿里云北京）",
        ...
        "High": "高",
        "XHigh": "极高",
        "Off disables Qwen reasoning for the fastest refinement.": "关闭 Qwen 推理可获得最快的文本优化速度。",
